...
fun PhotoCaptureActions(
    ...
    Row(
        ...
        OutlinedButton(
            ...
            Icon(Icons.Default.PhotoLibrary, contentDescription = "Pick from Gallery", tint = Color.Black)
            Spacer(modifier = Modifier.width(4.dp))
            Text("Gallery", maxLines = 1, color = Color.Black, style = MaterialTheme.typography.bodyMedium)
        }
    }
}
