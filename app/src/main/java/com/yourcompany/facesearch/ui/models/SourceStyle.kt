...
object SourceStyles {
    fun getStyle(source: String): SourceStyle {
        ...
        return when {
            ...
            s.contains("vkontakte") || s.contains("vk.com") -> SourceStyle(
                Color(0xFF0077FF), Icons.Default.Share, Brush.verticalGradient(listOf(Color(0xFF0077FF), Color(0xFF0055CC)))
            )
            s.contains("search4faces") -> SourceStyle(
                Color(0xFFE91E63), Icons.Default.Search, Brush.verticalGradient(listOf(Color(0xFFF48FB1), Color(0xFFC2185B)))
            )
